			...
			<div>
				...
				<div class="card post-input-box">
					<div class="title-input-box d-flex text-center">
						<label class="col-2 p-1 m-1" style="font-weight:bold;font-size:20px">제목</label><input class="form-control" id="titleInput" value="${trade.title }">
						
					</div>
				 	<textarea id="summernote">${trade.content }</textarea>
...
$(document).ready(function() {
	$("#submitBtn").on("click",function(){
		...
		///board/trade/new/input
		$.ajax({
			type:"post"
			,url:"/board/trade/update/input"
			,data:{"title":title,"content":content,"tradeId":${trade.id}}
