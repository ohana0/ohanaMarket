			...
			<div>
				...
				<div class="card post-input-box">
					<div class="title-input-box">
						...
						<input class="form-control col-10 m-2" id="titleInput" value="${trade.title }"></label>
					</div>
					<div class="d-flex">
						<div class="content-input-area col-8">
						
						 	<textarea class="form-control" rows="15" id="contentInput">${trade.content }</textarea>
						...
						<div class="price-type-location-area col-4">
							...
							<div class="price-area m-2">
								...
								<input id="priceInput" type="number" class="form-control col-9" value="${trade.price }"></label>
							</div>
							...
							<div class="trade-location-area m-2">
								...
								<input id="locationInput" type="text" class="form-control" value="${trade.tradeLocation }" disabled>
							</div>
							<div class="image-input-area m-2">
								<label>이미지 등록(수정시 이전의 이미지는 삭제됩니다.)
									<input id="imageInput" type="file" class="form-control" accept="image/*" multiple/>
								</label>
								
							</div>
							<div class="d-flex">
								<label>판매등록<input type="radio" name="state" value="판매등록" checked></label>
